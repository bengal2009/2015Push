...
public class ImageDownladerActivity extends Activity {
    ...
    private String downloadUrl = "http://images.cnitblog.com/blog/430074/201305/22001155-02386f79de544ba8a63fd629d6e26654.jpg";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_image_downlader);
